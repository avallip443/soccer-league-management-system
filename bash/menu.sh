        ...
        case "$CHOICE" in
            ...
            6)
                ...
                while true; do
                    ...
                    echo "| Select a query to run:                                         |"
                    echo "-----------------------------------------------------------------"
                    echo " 1) Query 1: Players who scored >2 goals and/or assisted >1 goals"
                    echo " 2) Query 2: Players who scored higher than 0.5"
                    echo " 3) Query 3: Numbef of games officiated by referees"
                    echo " 4) Query 4: Players who scored with no yellow cards"
                    echo " 5) Query 5: Players with no red cards"
                    echo " 6) Return to Main Menu"
                    echo "Choose: "
