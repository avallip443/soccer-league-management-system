...
INSERT INTO CompetitionAdmin (CompetitionAdminID, FirstName, LastName, Email, PhoneNumber, Username, AdminPassword) 
VALUES (4, 'Joseph', 'Guirguis', 'joe027@example.com', '400-000-0000', 'joe027', 'password123');
...
VALUES (1, 1, 'Arsenal', 0, 0, 0, 0, 0, 0, 'Emirates Stadium');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (2, 1, 'Liverpool', 0, 0, 0, 0, 0, 0, 'Anfield');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (3, 1, 'Manchester City', 0, 0, 0, 0, 0, 0, 'Etihad Stadium');

-- Insert LaLiga teams
INSERT INTO Team (TeamID, LeagueID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (4, 2, 'Real Madrid', 0, 0, 0, 0, 0, 0, 'Santiago Bernabeu');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (5, 2, 'Barcelona', 0, 0, 0, 0, 0, 0, 'Camp Nou');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (6, 2, 'Atletico Madrid', 0, 0, 0, 0, 0, 0, 'Wanda Metropolitano');

-- Insert Serie A teams
INSERT INTO Team (TeamID, LeagueID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (7, 3, 'Juventus', 0, 0, 0, 0, 0, 0, 'Allianz Stadium');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (8, 3, 'AC Milan', 0, 0, 0, 0, 0, 0, 'San Siro');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (9, 3, 'Inter Milan', 0, 0, 0, 0, 0, 0, 'San Siro');

-- Insert Mississauga league teams
INSERT INTO Team (TeamID, LeagueID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (10, 4, 'Mississauga Warriors', 10, 3, 2, 1, 14, 7, 'Churchill Medows Arena');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (11, 4, 'Mississauga Dragons', 8, 2, 2, 2, 14, 12, 'Erin Mills Arena');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (12, 4, 'Mississauga Eagles', 7, 2, 3, 1, 11, 20, 'Square One Arena');

INSERT INTO Team (TeamID, LeagueID, CompetitionAdminID, TeamName, Points, Wins, Losses, Draws, GoalsFor, GoalsAgainst, Venue) 
VALUES (13, 4, 'Mississauga Bull Dogs', 8, 2, 2, 2, 14, 14, 'Liverpool Frauds Arena');
...
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (4, 1, 'William', 'Saliba', 'swaliba@arsenal.com', '000-000-0004', 'swaliba', 'password789', 'Defender');

-- Insert players for Liverpool
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (5, 2, 'Alisson', 'Becker', 'abecker@arsenal.com', '000-000-0005', 'abecker', 'password123', 'Goalkeeper');

INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (6, 2, 'Luis', 'Díaz', 'ldiaz@arsenal.com', '000-000-0006', 'ldiaz', 'password789', 'Forward');

INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (7, 2, 'Ryan', 'Gravenberch', 'rgravenberch@arsenal.com', '000-000-0007', 'rgravenberch', 'password789', 'Midfielder');
 
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (8, 2, 'Virgil', 'van Dijk', 'vdijk@arsenal.com', '000-000-0008', 'vdijk', 'password789', 'Defender');

-- Insert players for Manchester City
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (9, 3, 'Ederson', 'Santana de Moraes', 'emoraes@arsenal.com', '000-000-0009', 'emoraes', 'password123', 'Goalkeeper');

INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (10, 3, 'Erling', 'Haaland', 'ehaaland@arsenal.com', '000-000-0010', 'ltrossard', 'password456', 'Forward');

INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (11, 3, 'Bernardo', 'Silva', 'bsilva@arsenal.com', '000-000-0011', 'bsilva', 'password789', 'Midfielder');
 
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (12, 3, 'Josko', 'Gvardiol', 'jgvardiol@arsenal.com', '000-000-0012', 'jgvardiol', 'password789', 'Defender');
...
INSERT INTO Player (PlayerID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, PlayerPassword, PlayerPosition) 
VALUES (15, 4, 'Luka', 'Modrić', 'lmodric@realmadrid.com', '000-000-0015', 'lmodric', 'password789', 'Midfielder');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (2, 1, 'Albert', 'Stuivenberg', 'astuivenberg@arsenal.com', '000-002-0000', 'astuivenberg', 'password234', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (4, 2, 'Sipke', 'Hulshoff', 'shulshoff@liverpool.com', '000-004-0000', 'shulshoff', 'password567', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (6, 3, 'Carlos', 'Vicens', 'cvicens@manchestercity.com', '000-006-0000', 'cvicens', 'password890', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (8, 5, 'Davide', 'Ancelotti', 'dancelotti@realmadrid.com', '000-008-0000', 'dancelotti', 'password234', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (10, 6, 'Nelson', 'Vivas', 'nvivas@atleticomadrid.com', '000-010-0000', 'nvivas', 'password567', 'Assistant Manager');

-- Insert management for Juventus
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (11, 7, 'Thiago', 'Motta', 'tmotta@juventus.com', '000-011-0000', 'tmotta', 'password789', 'Head Manager');

INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (12, 7, 'Alexandre', 'Hugeux', 'ahugeux@juventus.com', '000-012-0000', 'ahugeux', 'password890', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (14, 8, 'Paulo', 'Ferreira', 'pferreira@acmilan.com', '000-014-0000', 'pferreira', 'password234', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (18, 10, 'Sindi2', 'Gur', 'sindi2@mwarriors.com', '000-018-0000', 'sindig2', 'password456', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (20, 11, 'Arathi2', 'Vall', 'arathi2@mdragons.com', '000-020-0000', 'arathiv2', 'password567', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (22, 12, 'Sindi4', 'Gur', 'sindi4@mwarriors.com', '000-022-0000', 'sindig4', 'password456', 'Assistant Manager');
...
INSERT INTO TeamManagement (TeamManagementID, TeamID, FirstName, LastName, Email, PhoneNumber, Username, ManagementPassword, TeamRole) 
VALUES (24, 13, 'Arathi4', 'Vall', 'arathi4@mdragons.com', '000-024-0000', 'arathiv4', 'password567', 'Assistant Manager');
