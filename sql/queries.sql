...
I will transfer the top 4 teams to another competition admin (Anne) who is controlling a league that is more prestigious.
*/
...
/* 
3) A general Mississauga League fan wants to go on the website and check the player with the most goals scored in the league to see if his favourite player is doing well this season.
*/
